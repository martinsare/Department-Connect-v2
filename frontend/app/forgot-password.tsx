...
import { KeyboardAwareScrollViewCompat } from "@/frontend/components/KeyboardAwareScrollViewCompat";
import { SuccessAnimation } from "@/frontend/components/AnimatedStatus";
      ...
      >
        <View style={styles.sentCard}>
          ...
          <Text style={styles.sentBody}>
            Password reset instructions have been sent to the contact
          ...
          <View style={styles.demoNote}>
            ...
            <Text style={styles.demoNoteText}>
              ...
              Your password remains{" "}
              <Text style={{ fontFamily: "Inter_700Bold" }}>"password"</Text>.
