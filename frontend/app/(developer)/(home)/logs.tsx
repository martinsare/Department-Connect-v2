...
import type { AuditLog } from "@/frontend/context/DataContext";
    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        ...
        <Text style={styles.subtitle}>
          {auditLogs.length} entries · June 20, 2026
        </Text>
      </LinearGradient>
      ...
      <FlatList
        ...
        renderItem={({ item: log }) => {
          const iconName =
            ACTION_ICONS[log.action] ?? "information-circle-outline";
          ...
          return (
            ...
            >
              <View
                style={[styles.iconWrap, { backgroundColor: roleColor + "18" }]}
              >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text
                  style={[styles.logUser, { color: colors.mutedForeground }]}
                >
                  {log.user}
                </Text>
                <Text
                  style={[styles.logDetail, { color: colors.mutedForeground }]}
                  numberOfLines={1}
                >
                  {log.details}
                </Text>
        ...
        <View style={detail.overlay}>
          <View style={[detail.sheet, { backgroundColor: colors.card }]}>
            ...
            {selected &&
              (() => {
                const iconName =
                  ACTION_ICONS[selected.action] ?? "information-circle-outline";
