      ...
      ? [
          {
            ...
            iconColor: "#F59E0B",
            title: `${pending.length} Pending Student Approval${
              pending.length !== 1 ? "s" : ""
            }`,
            body: `Awaiting admin review: ${pending
      ...
      ? [
          {
            ...
            body: todayClasses
              .map((c) => `${c.courseCode} ${c.startTime}`)
              .join(", "),
            time: "Today",
            isRead: true,
            tag: "system" as const,
        ...
        <View style={styles.headerRow}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.subtitle}>
              {unreadCount > 0
                ? `${unreadCount} unread · Admin + Student + System`
                : "All caught up"}
            </Text>
          </View>
          {unreadCount > 0 && (
        ...
        renderItem={({ item }) => (
          <TouchableOpacity
            style={[
              styles.row,
              {
                backgroundColor: item.isRead ? colors.background : "#F59E0B08",
              },
            ]}
            onPress={() => {
              Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
          ...
          >
            ...
            <View style={{ flex: 1, gap: 3 }}>
              <View style={styles.titleRow}>
                ...
                >
                  <Text
                    style={[styles.tagText, { color: TAG_COLORS[item.tag] }]}
                  >
                    {TAG_LABELS[item.tag]}
                  </Text>
                </View>
