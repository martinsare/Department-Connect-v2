...
import { ONBOARDING_STORAGE_KEY } from "@/frontend/data/seedData";
...
const SLIDES = [
  {
    ...
    title: "Welcome to\nDepartment Connect",
    subtitle:
      "Your all-in-one academic management platform. Stay connected with your department community.",
    accent: "#7C3AED",
  },
  {
    ...
    title: "Track Classes\n& Attendance",
    subtitle:
      "Never miss a class. Scan QR codes for instant attendance, view your records anytime.",
    accent: "#6D28D9",
  },
  {
    ...
    title: "Stay Updated\nInstantly",
    subtitle:
      "Get real-time announcements, event notifications, and important updates from your department.",
    accent: "#5B21B6",
  },
  {
    ...
    title: "Your Academic\nCommunity",
    subtitle:
      "Connect with classmates, access resources, and manage contributions — all in one place.",
    accent: "#4C1D95",
  },
];

const ILLUS_H = SCREEN_H * 0.5;
...
export default function OnboardingScreen() {
  ...
  return (
    <View style={[styles.root, { paddingTop: topPad }]}>
      ...
      {/* Content */}
      <Animated.View
        style={[styles.content, { paddingBottom: botPad, opacity: fadeAnim }]}
      >
        {/* Dots */}
