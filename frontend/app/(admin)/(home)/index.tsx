...
export default function AdminDashboard() {
  ...
  const filterAttByLevel = (records: typeof attendanceS1, lf: string) => {
    ...
    return records.filter((r) => {
      const m = r.courseCode.match(/\d+/);
      return m ? m[0][0] === prefix : false;
    });
  };
  ...
  const modalAvgAtt =
    modalAttRecords.length > 0
      ? Math.round(
          modalAttRecords.reduce((s, r) => s + r.percentage, 0) /
            modalAttRecords.length
        )
      : 0;
  ...
  const outstandingPayments = contributions.filter(
    (c) => c.status === "unpaid" || c.status === "rejected"
  ).length;

  const upcomingEvents = events
    .filter((e) => e.date >= "2026-06-20")
    .slice(0, 2);
  ...
  const handlePostAnnouncement = async () => {
    ...
    addAnnouncement({
      title: annTitle.trim(),
      body: annBody.trim(),
      postedBy: `${user?.firstName} ${user?.surname} (${
        user?.subRole ?? "Admin"
      })`,
      time: "Just now",
    ...
    Alert.alert(
      "Announcement Posted",
      `Your announcement has been sent to ${annTarget}.`
    );
  };
    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
          ...
          >
            ...
            <View>
              ...
              <Text style={styles.role}>
                {user?.subRole ?? "Admin"} · {user?.department}
              </Text>
            </View>
          </TouchableOpacity>
      ...
      >
          ...
          <>
            ...
            >
              ...
              <Text
                style={[
                  styles.sectionTitle,
                  { color: colors.foreground, marginTop: 0, marginBottom: 0 },
                ]}
              >
                Pending Approvals
              </Text>
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.pendingMeta}>
                    {s.matricNumber} · {s.level}
                  </Text>
                </View>
                <View
                  style={[styles.pendingBadge, { backgroundColor: "#FEF3C7" }]}
                >
        ...
        {announcements.slice(0, 3).map((an) => (
          ...
          >
            <Text style={[styles.annoTitle, { color: colors.foreground }]}>
              {an.title}
            </Text>
            <Text
              style={[styles.annoBody, { color: colors.mutedForeground }]}
              numberOfLines={2}
            >
              {an.body}
            </Text>
            <Text style={[styles.annoMeta, { color: colors.mutedForeground }]}>
              {an.postedBy} · {an.time}
            </Text>
          </View>
        ))}
      ...
      >
        <View style={anlStyles.overlay}>
          <View style={[anlStyles.sheet, { backgroundColor: colors.card }]}>
            <View
              style={[anlStyles.handle, { backgroundColor: colors.border }]}
            />
            <View style={anlStyles.header}>
              <Text style={[anlStyles.title, { color: colors.foreground }]}>
            ...
            >
                  ...
                  {([1, 2] as const).map((s) => (
                    <TouchableOpacity
                      ...
                      style={{
                        ...
                        borderRadius: 6,
                        backgroundColor:
                          modalAttSem === s ? colors.primary : "transparent",
                      }}
                      onPress={() => {
                        Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
                        setModalAttSem(s);
                    ...
                    >
                      <Text
                        style={{
                          ...
                          color:
                            modalAttSem === s ? "#fff" : colors.mutedForeground,
                        }}
                      >
                        S{s}
                      </Text>
              ...
              >
                {modalAttSem === 1 ? "1st" : "2nd"} Semester ·{" "}
                {modalAttRecords.length} course
                {modalAttRecords.length !== 1 ? "s" : ""} · avg {modalAvgAtt}%
              </Text>
              ...
              <View style={anlStyles.metricRow}>
                <View
                  style={[
                    anlStyles.metricBox,
                    { backgroundColor: "#7C3AED15", flex: 1 },
                  ]}
                >
                  <Ionicons name="people-outline" size={20} color="#7C3AED" />
                  <Text
                    style={[anlStyles.metricVal, { color: colors.foreground }]}
                  >
                    {modalAvgAtt}%
                  </Text>
                  <Text
                    style={[
                      anlStyles.metricLabel,
                      { color: colors.mutedForeground },
                    ]}
                  >
                    Avg rate
                ...
                <View
                  style={[
                    anlStyles.metricBox,
                    { backgroundColor: "#10B98115", flex: 1 },
                  ]}
                >
                  <Ionicons
              ...
              {modalAttRecords.length === 0 ? (
                ...
                >
                  No {modalAttLevel === "All" ? "" : modalAttLevel + " "}courses
                  this semester
                </Text>
              ) : (
              ...
              {/* Financial */}
              <Text style={[anlStyles.section, { color: colors.foreground }]}>
                Financial Summary
              </Text>
              <View style={anlStyles.metricRow}>
                <View
                ...
                >
                  ...
                  <Text
                    style={[anlStyles.metricVal, { color: colors.foreground }]}
                  >
                    ₦{paidContributions.toLocaleString()}
                  </Text>
                  <Text
                    style={[
                      anlStyles.metricLabel,
                ...
                <View
                  style={[
                    anlStyles.metricBox,
                    { backgroundColor: "#EF444415", flex: 1 },
                  ]}
                >
                  ...
                  <Text
                    style={[anlStyles.metricVal, { color: colors.foreground }]}
                  >
                    ₦{(totalContributions - paidContributions).toLocaleString()}
                  </Text>
                  <Text
                    style={[
                      anlStyles.metricLabel,
                    ...
                    <View style={anlStyles.barRow}>
                      <View style={{ flex: 1 }}>
                        <View style={anlStyles.barLabelRow}>
                          ...
                          <Text
                            style={[anlStyles.barPct, { color: "#10B981" }]}
                          >
                            {collPct}%
                          </Text>
                        </View>
                  ...
                  <View key={lvl} style={anlStyles.barRow}>
                    <View style={{ flex: 1 }}>
                      <View style={anlStyles.barLabelRow}>
                        ...
                        <Text
                          style={[anlStyles.barPct, { color: colors.primary }]}
                        >
                          {pct}%
                        </Text>
                      </View>
              ...
              <View style={anlStyles.metricRow}>
                <View
                  style={[
                    anlStyles.metricBox,
                    { backgroundColor: "#F59E0B15", flex: 1 },
                  ]}
                >
                ...
                <View
                  style={[
                    anlStyles.metricBox,
                    { backgroundColor: "#8B5CF615", flex: 1 },
                  ]}
                >
                  <Ionicons
      ...
      >
        <View style={annStyles.overlay}>
          <View style={[annStyles.sheet, { backgroundColor: colors.card }]}>
            ...
            <Text style={[annStyles.label, { color: colors.mutedForeground }]}>
              Title *
            </Text>
            <TextInput
              style={[
              ...
              {CATEGORIES.map((c) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    {
                      backgroundColor:
                        annCategory === c ? colors.primary : colors.muted,
                      borderColor:
                        annCategory === c ? colors.primary : colors.border,
                    },
                  ]}
                ...
                >
                  <Text
                    style={[
                      ...
                      {
                        color:
                          annCategory === c ? "#fff" : colors.mutedForeground,
                      },
                    ]}
                  >
                    {c}
              ...
              {TARGET_OPTIONS.map((t) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    {
                      backgroundColor:
                        annTarget === t ? colors.primary : colors.muted,
                      borderColor:
                        annTarget === t ? colors.primary : colors.border,
                    },
                  ]}
                ...
                >
                  <Text
                    style={[
                      ...
                      {
                        color:
                          annTarget === t ? "#fff" : colors.mutedForeground,
                      },
                    ]}
                  >
                    {t}
            ...
            <TouchableOpacity
              style={[
                annStyles.postBtn,
                { backgroundColor: posting ? colors.muted : colors.primary },
              ]}
            ...
            >
              ...
              <Text style={annStyles.postBtnText}>
