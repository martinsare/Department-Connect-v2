  ...
  return (
    <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
      <View style={[barS.track, { flex: 1 }]}>
        <View
          style={[barS.fill, { width: `${pct}%`, backgroundColor: color }]}
        />
      </View>
      <Text
        style={{
...
export default function AnalyticsScreen() {
  ...
  const { students, classes, contributions, attendanceS1, attendanceS2 } =
    useData();
  ...
  const avgAtt =
    attRecords.length > 0
      ? Math.round(
          attRecords.reduce((s, r) => s + r.percentage, 0) / attRecords.length
        )
      : 0;
      ...
      >
        <View style={styles.quickStats}>
          {[
            ...
            >
              ...
              <Text
                style={[styles.quickStatValue, { color: colors.foreground }]}
              >
                {s.value}
              </Text>
              <Text
          ...
          <View style={styles.levelList}>
            {levelBreakdown.map((l) => (
              <View key={l.level} style={styles.levelRow}>
                ...
                <Text
                  style={[styles.levelCount, { color: colors.mutedForeground }]}
                >
                  {l.count}
                </Text>
              </View>
        ...
        >
          <View style={styles.cardHeader}>
            ...
            <View style={[styles.semToggle, { backgroundColor: colors.muted }]}>
              <TouchableOpacity
                style={[
                  styles.semBtn,
                  attSemester === 1 && { backgroundColor: colors.primary },
                ]}
              ...
              <TouchableOpacity
                style={[
                  styles.semBtn,
                  attSemester === 2 && { backgroundColor: colors.primary },
                ]}
          ...
          <Text style={[styles.semLabel, { color: colors.mutedForeground }]}>
            {attSemester === 1 ? "1st" : "2nd"} Semester · {attRecords.length}{" "}
            course{attRecords.length !== 1 ? "s" : ""} · avg {avgAtt}%
          </Text>
        ...
        >
          ...
          <View style={styles.finRow}>
            ...
            >
              ...
              <Text
                style={[styles.finLabel, { color: colors.mutedForeground }]}
              >
                Collected
              </Text>
            </View>
          ...
          <View style={styles.finBarTrack}>
            <View
              style={[
                styles.finBarFill,
                { backgroundColor: colors.success, width: `${collectionPct}%` },
              ]}
            />
          </View>
