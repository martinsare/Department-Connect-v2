...
import { useData, type StudentStatus } from "@/frontend/context/DataContext";
import { formatDob } from "@/utils/formatDob";
import { useColors } from "@/hooks/useColors";
import { LottieEmpty } from "@/frontend/components/LottieEmpty";
import { Avatar } from "@/frontend/components/Avatar";
import { LEVELS as SEED_LEVELS } from "@/frontend/data/seedData";
...
export default function StudentsScreen() {
  ...
  const { students, addStudent, updateStudentLevel, bulkUpdateLevel } =
    useData();
  ...
  const handleAdd = async () => {
    ...
    if (existing) {
      setFormErrors({
        matricNumber: "This matric number is already registered",
      });
      setSubmitting(false);
      return;
    }
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              style={[
                ...
                {
                  backgroundColor:
                    levelFilter === item ? colors.primary : colors.muted,
                  borderColor:
                    levelFilter === item ? colors.primary : colors.border,
                },
              ]}
            ...
            >
              <Text
                style={[
                  ...
                  {
                    color:
                      levelFilter === item ? "#fff" : colors.mutedForeground,
                  },
                ]}
              >
                {item}
          ...
          return (
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  {s.matricNumber} · {formatDob(s.dob, s.hideYear ?? true)}
                </Text>
                <View style={styles.studentBottom}>
                  <Text
                    style={[
                      ...
                      {
                        color:
                          s.level === "Graduated" ? "#6366F1" : colors.primary,
                      },
                    ]}
                  >
                    {s.level}
                  ...
                  <>
                    ...
                    >
                      ...
                      <View style={{ flex: 1 }}>
                        ...
                        >
                          {detailStudent.firstName} {detailStudent.surname}
                        </Text>
                        <Text
                          style={{
                            fontSize: 13,
                    ...
                    >
                      ...
                      >
                        ...
                        <Text
                          style={[
                            styles.statusText,
                            { color: sc, fontSize: 13 },
                          ]}
                        >
                          {detailStudent.status.charAt(0).toUpperCase() +
                            detailStudent.status.slice(1)}
                        </Text>
                      </View>
                      <View style={{ flex: 1 }} />
                      <Text
                    ...
                    {[
                      ...
                      {
                        label: "Email",
                        value: detailStudent.email || "—",
                        icon: "mail-outline" as const,
                      },
                      {
                        label: "Submitted",
                        value: detailStudent.submittedAt || "—",
                    ...
                    >
                      ...
                      >
                        Tap a level to promote or move this student. Change
        ...
        <View style={addStyles.overlay}>
          ...
          >
            <View style={addStyles.header}>
              <Text style={[addStyles.title, { color: colors.foreground }]}>
            ...
            >
              Move all active students from one level to another in a single
              action — ideal for end-of-year progression.
            </Text>
            ...
            >
              Start from the top — promote 500L first so you don't fill a level
              before clearing it
            </Text>
            <View
              style={{
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      addStyles.levelChip,
                      {
                        backgroundColor: sel ? "#7C3AED" : colors.muted,
                  ...
                  >
                    <Text
                      style={[
                        addStyles.levelChipText,
                        { color: sel ? "#fff" : colors.mutedForeground },
                      ]}
                    >
                      {l}
                    </Text>
            ...
            <View
              style={{
                backgroundColor:
                  bulkAffectedCount === 0 ? colors.muted : "#7C3AED18",
                borderRadius: 12,
                padding: 14,
                marginBottom: 20,
                borderWidth: 1,
                borderColor:
                  bulkAffectedCount === 0 ? colors.border : "#7C3AED40",
              }}
            >
              {bulkAffectedCount === 0 ? (
                <Text
                ...
                >
                  {bulkAffectedCount} active student
                  {bulkAffectedCount !== 1 ? "s" : ""} will move{"\n"}
            ...
            <TouchableOpacity
              style={{
                ...
                alignItems: "center",
                backgroundColor:
                  bulkAffectedCount === 0 ? colors.muted : "#7C3AED",
              }}
              ...
              onPress={() => {
                Alert.alert(
                  ...
                  `Move ${bulkAffectedCount} active student${
                    bulkAffectedCount !== 1 ? "s" : ""
                  } from ${bulkFrom} to ${bulkTo}? This cannot be undone.`,
                  [
            ...
            >
              <Text
                style={{
                  ...
                  fontFamily: "Inter_600SemiBold",
                  color:
                    bulkAffectedCount === 0 ? colors.mutedForeground : "#fff",
                }}
              >
                Promote{" "}
                {bulkAffectedCount > 0 ? `${bulkAffectedCount} Students` : "—"}
              </Text>
            </TouchableOpacity>
          </View>
        </View>
          ...
          <View style={[addStyles.sheet, { backgroundColor: colors.card }]}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              <View style={addStyles.row}>
                <View style={{ flex: 1 }}>
                  <Text
                    style={[addStyles.label, { color: colors.mutedForeground }]}
                  >
                    First Name *
                  </Text>
                  <TextInput
                  ...
                  {formErrors.firstName ? (
                    <Text style={addStyles.error}>{formErrors.firstName}</Text>
                  ) : null}
                </View>
                <View style={{ flex: 1 }}>
                  <Text
                  ...
                  />
                  {formErrors.surname ? (
                    <Text style={addStyles.error}>{formErrors.surname}</Text>
                  ) : null}
                </View>
              </View>
              ...
              >
                Matric Number *{" "}
                <Text style={addStyles.hint}>(e.g. ART2500001)</Text>
              </Text>
              <TextInput
                style={[
                  addStyles.field,
                  {
                    backgroundColor: colors.muted,
                    color: colors.foreground,
                    borderColor: formErrors.matricNumber
                      ? "#EF4444"
                      : colors.border,
                  },
                ]}
              ...
              {formErrors.matricNumber ? (
                <Text style={addStyles.error}>{formErrors.matricNumber}</Text>
              ) : null}

              <Text
                style={[addStyles.label, { color: colors.mutedForeground }]}
              >
                Date of Birth * <Text style={addStyles.hint}>(YYYY-MM-DD)</Text>
              </Text>
              <TextInput
                style={[
                  addStyles.field,
                  {
                    backgroundColor: colors.muted,
                    color: colors.foreground,
                    borderColor: formErrors.dob ? "#EF4444" : colors.border,
                  },
                ]}
              ...
              />
              {formErrors.dob ? (
                <Text style={addStyles.error}>{formErrors.dob}</Text>
              ) : null}

              <Text
                style={[addStyles.label, { color: colors.mutedForeground }]}
              >
                Phone Number * <Text style={addStyles.hint}>(080XXXXXXXX)</Text>
              </Text>
              <TextInput
                style={[
                  addStyles.field,
                  {
                    backgroundColor: colors.muted,
                    color: colors.foreground,
                    borderColor: formErrors.phone ? "#EF4444" : colors.border,
                  },
                ]}
              ...
              />
              {formErrors.phone ? (
                <Text style={addStyles.error}>{formErrors.phone}</Text>
              ) : null}
              ...
              >
                Email{" "}
                <Text style={addStyles.hint}>(optional — recovery only)</Text>
              </Text>
              <TextInput
                style={[
                  addStyles.field,
                ...
                {LEVEL_OPTIONS.map((l) => (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      {
                        backgroundColor:
                          level === l ? colors.primary : colors.muted,
                        borderColor:
                          level === l ? colors.primary : colors.border,
                      },
                    ]}
                    onPress={() => setLevel(l)}
                    activeOpacity={0.8}
                  >
                    <Text
                      style={[
                        addStyles.levelChipText,
                        {
                          color: level === l ? "#fff" : colors.mutedForeground,
                        },
                      ]}
                    >
                      {l}
              ...
              <View
                style={[addStyles.statusNote, { backgroundColor: "#FEF3C7" }]}
              >
                <Ionicons
                ...
                <Text style={addStyles.statusNoteText}>
                  ...
                  status. A Lecturer or Course Rep must approve before the
                  student can log in.
                </Text>
              </View>
