...
import type { NotificationCategory } from "@/frontend/context/DataContext";
...
const PREFS_LABELS: Record<
  NotificationCategory,
  { label: string; desc: string }
> = {
  lectures: {
    label: "Lectures",
    desc: "Class schedules, attendance alerts, cancellations",
  },
  big_events: {
    label: "Big Events",
    desc: "Department-wide events and major occasions",
  },
  small_events: {
    label: "Small Events",
    desc: "Group activities, study sessions, meetings",
  },
  extras: {
    label: "Extras & Financials",
    desc: "Payments, birthdays, announcements, reminders",
  },
};
            ...
            >
              ...
              <View style={styles.notifContent}>
                <View style={styles.notifTopRow}>
                  ...
                  {n.priority === "high" && (
                    <View
                      style={[styles.highBadge, { backgroundColor: "#FEE2E2" }]}
                    >
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={[styles.prefsSheet, { backgroundColor: colors.card }]}>
            <View
              style={[styles.prefsHandle, { backgroundColor: colors.border }]}
            />
            <View style={styles.prefsHeader}>
              <Text style={[styles.prefsTitle, { color: colors.foreground }]}>
            ...
            <Text style={[styles.prefsSub, { color: colors.mutedForeground }]}>
              Choose which notifications you receive. Some alerts (class
              cancellations, payment deadlines) cannot be disabled.
            </Text>
            {(Object.keys(PREFS_LABELS) as NotificationCategory[]).map(
              (cat) => {
