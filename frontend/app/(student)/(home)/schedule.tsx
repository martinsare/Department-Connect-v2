          ...
          {DAYS.map((d, i) => (
            ...
            >
              ...
              <Text
                style={[
                  styles.dateLabel,
                  selectedDay === i && styles.dateLabelActive,
                ]}
              >
                {DATES[i]}
              </Text>
          ...
          dayClasses.map((cls) => {
            ...
            return (
              <View
                ...
                style={[
                  styles.card,
                  { backgroundColor: colors.card, borderLeftColor: col },
                ]}
              >
                <View style={styles.timeCol}>
                  <Text
                    style={[styles.startTime, { color: colors.foreground }]}
                  >
                    {cls.startTime.split(" ")[0]}
                  </Text>
                  <Text
                    style={[styles.ampm, { color: colors.mutedForeground }]}
                  >
                  ...
                  />
                  <Text
                    style={[styles.endTime, { color: colors.mutedForeground }]}
                  >
                    {cls.endTime.split(" ")[0]}
                  </Text>
                </View>
