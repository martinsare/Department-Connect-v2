...
import { useData, type Contribution } from "@/frontend/context/DataContext";
        ...
        <View style={[mStyles.sheet, { backgroundColor: colors.card }]}>
          ...
          <View style={mStyles.header}>
            <View>
              ...
              <Text
                style={[mStyles.subtitle, { color: colors.mutedForeground }]}
              >
                {contribution.title}
              </Text>
            </View>
          ...
          <View style={[mStyles.amountBox, { backgroundColor: "#7C3AED18" }]}>
            <Text
              style={[mStyles.amountLabel, { color: colors.mutedForeground }]}
            >
              Amount to Transfer
            </Text>
            <Text style={mStyles.amount}>
          ...
          >
            <Text style={[mStyles.detailsTitle, { color: colors.foreground }]}>
              Transfer to this account
            </Text>

            <View style={mStyles.detailRow}>
              <Text
                style={[mStyles.detailLabel, { color: colors.mutedForeground }]}
              >
                Bank Name
              </Text>
              <Text style={[mStyles.detailValue, { color: colors.foreground }]}>
            ...
            <View style={[mStyles.detailRow, mStyles.accountRow]}>
              <View style={{ flex: 1 }}>
                ...
                <Text
                  style={[mStyles.accountNumber, { color: colors.foreground }]}
                >
              ...
              <TouchableOpacity
                style={[
                  mStyles.copyBtn,
                  {
                    backgroundColor: copied ? "#10B98118" : "#7C3AED18",
          ...
          >
            ...
            <Text style={mStyles.noteText}>
              Transfer the exact amount and use your{" "}
              <Text style={{ fontFamily: "Inter_700Bold" }}>full name</Text> as
          ...
          {!confirmed ? (
            <TouchableOpacity
              style={mStyles.paidBtn}
              onPress={handlePaid}
              activeOpacity={0.85}
            >
              <LinearGradient
                colors={["#7C3AED", "#5B21B6"]}
                style={mStyles.paidGrad}
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 0 }}
              >
                <Ionicons
            ...
            >
              ...
              >
                ...
                <Text style={mStyles.paidBtnText}>
          ...
          <Text style={[mStyles.footNote, { color: colors.mutedForeground }]}>
            ...
            <Text style={{ fontFamily: "Inter_600SemiBold", color: "#7C3AED" }}>
              Pending
            </Text>{" "}
            until Admin confirms your transfer.
          </Text>
        </View>
      </View>
    </Modal>
...
function ContributionCard({
  ...
  const daysLeft = Math.ceil(
    (new Date(item.deadline).getTime() - new Date("2026-06-20").getTime()) /
      86400000
  );
  ...
  return (
    ...
    >
      <View style={cardS.top}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={[cardS.title, { color: colors.foreground }]}>
            {item.title}
          </Text>
          {item.description ? (
            <Text
              style={[cardS.desc, { color: colors.mutedForeground }]}
              numberOfLines={2}
            >
              {item.description}
            </Text>
        ...
        <View style={cardS.right}>
          ...
          {item.status === "confirmed" && (
            <View style={[cardS.badge, { backgroundColor: "#D1FAE5" }]}>
              ...
              <Text style={[cardS.badgeText, { color: "#10B981" }]}>
                Confirmed
              </Text>
            </View>
          )}
          ...
          {item.status === "pending" && (
            <View style={[cardS.badge, { backgroundColor: "#F3EEFF" }]}>
              ...
              <Text style={[cardS.badgeText, { color: "#7C3AED" }]}>
                Awaiting Admin
              </Text>
            </View>
          )}
...
export default function PaymentsScreen() {
  ...
  const myContributions = contributions.filter(
    (c) => c.level === user?.level || !user?.level
  );
  ...
  const unpaidCount = myContributions.filter(
    (c) => c.status === "unpaid"
  ).length;
        ...
        <View style={styles.summaryRow}>
          <View style={styles.summaryCard}>
            ...
            <Text
              style={[
                styles.summaryValue,
                { color: totalOwed > 0 ? "#FBBF24" : "#34D399" },
              ]}
            >
