          ...
          return (
            <View key={rec.courseCode} style={[styles.courseCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
              <View style={styles.courseHeader}>
                ...
                <Text style={[styles.coursePct, { color: c }]}>{rec.percentage}%</Text>
              </View>
              <View style={styles.barRow}>
                <AnimatedBar percentage={rec.percentage} color={c} />
              ...
              {rec.percentage < 70 && (
                <View style={[styles.warningRow, { backgroundColor: colors.destructive + "12" }]}>
                  ...
                  <Text style={[styles.warningText, { color: colors.destructive }]}>
                    Need {Math.ceil((0.75 * rec.total - rec.attended) / (1 - 0.75))} more classes to reach 75%
                  </Text>
                </View>
              )}
            </View>
...
const styles = StyleSheet.create({
  ...
  courseCard: { borderRadius: 16, borderWidth: 1, padding: 16, marginBottom: 12, gap: 10 },
  ...
  legend: { borderRadius: 16, borderWidth: 1, padding: 16, marginTop: 4, gap: 8 },
