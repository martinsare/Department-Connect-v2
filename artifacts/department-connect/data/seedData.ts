...
// ---------------------------------------------------------------------------
// STUDENTS  (shared between DataContext and AuthContext)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// AUTH USERS  (students with passwords — for the login screen)
// ---------------------------------------------------------------------------

export const DEMO_STUDENTS: (AuthUser & { password: string })[] = [
  { ...SEED_STUDENTS[0], role: "student", birthdayPrivacy: true,  password: "password" },
  { ...SEED_STUDENTS[1], role: "student", birthdayPrivacy: false, password: "password" },
  { ...SEED_STUDENTS[2], role: "student", birthdayPrivacy: false, password: "password" },
  { ...SEED_STUDENTS[3], role: "student", birthdayPrivacy: true,  password: "password" },
  { ...SEED_STUDENTS[4], role: "student", birthdayPrivacy: false, password: "password" },
  { ...SEED_STUDENTS[5], role: "student", birthdayPrivacy: false, password: "password" },
  { ...SEED_STUDENTS[6], role: "student", birthdayPrivacy: true,  password: "password" },
  { ...SEED_STUDENTS[7], role: "student", birthdayPrivacy: true,  password: "password" },
];

export const DEMO_ADMINS: (AuthUser & { password: string })[] = [
  {
    id: "a1",
    firstName: "Yusuf",
    surname: "Ibrahim",
...
export const DEMO_DEV: AuthUser & { password: string } = {
  id: "d1",
  firstName: "Dev",
  surname: "Martins",
  role: "developer",
...
export const SEED_ATTENDANCE_S1: AttendanceRecord[] = [
...
export const SEED_ATTENDANCE_S2: AttendanceRecord[] = [
...
export const SEED_CLASS_ATTENDEES: Record<string, ClassAttendee[]> = {
  cl1: [
...
export const QR_ATTENDANCE_TOKEN = "DEPT_CONNECT_2026";
export const AUTH_STORAGE_KEY = "dc_auth_user";
export const ONBOARDING_STORAGE_KEY = "dc_onboarding_done";

export const LEVELS = ["100L", "200L", "300L", "400L", "500L", "Graduated"] as const;
...
export const ANNOUNCEMENT_CATEGORIES = [
  "Academic", "Administrative", "Financial", "Social", "Urgent",
] as const;

export const EVENT_TARGET_OPTIONS = [
  "All Students", "100L", "200L", "300L", "400L", "500L",
] as const;

export const EVENT_REMINDER_OPTIONS = [
  "None", "24 hours before", "1 hour before", "Both",
] as const;
